 ...
 */
module.exports = function(d3_scale_linear, d3_time, d3_bisect, d3ts_util_rebindCallback, scale_widen, d3ts_scale_zoomable) {  // Injected dependencies
  function financetime(tickMethods, genericFormat, index, domain, padding, outerPadding, zoomLimit, closestTicks, zoomable) {
    ...
    zoomable = zoomable || d3ts_scale_zoomable(index, zoomed, zoomLimit);
    ...
    d3ts_util_rebindCallback(scale, index, zoomed, 'range');
