...
module.exports = function(d3_svg_line, d3_svg_area, d3_line_interpolate, d3_select) {
  ...
  function PathLine() {
    ...
    line.init = function(accessor_time, x, accessor_value, y, offset) {
      return d3Line.defined(function(d) { return accessor_value(d) !== null; })
          .x(function(d) { return x(accessor_time(d), offset === undefined ? offset : offset(d)); } )
  ...
  function PathArea() {
    ...
    area.init = function(accessor_time, x, accessor_value, y, yBase) {
      return d3Area.defined(function(d) { return accessor_value(d) !== null;  })
           .x(function(d) { return x(accessor_time(d)); } )
  ...
  /**
   * Helper class assists the composition of multiple d3ts plots. Handles:
  ...
  return {
    ...
    horizontalPathLine: function(accessor_time, x, accessor_value, y) {
      return function(d) {
