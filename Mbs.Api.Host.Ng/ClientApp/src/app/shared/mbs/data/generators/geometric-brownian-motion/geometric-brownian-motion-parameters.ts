    ...
    init(data?: any) {
        if (data) {
            this.amplitude = data['amplitude'] !== undefined
                ? data['amplitude'] : GeometricBrownianMotionParameters.defaultAmplitude;
            this.minimalValue = data['minimalValue'] !== undefined
                ? data['minimalValue'] : GeometricBrownianMotionParameters.defaultMinimalValue;
            this.drift = data['drift'] !== undefined
                ? data['drift'] : GeometricBrownianMotionParameters.defaultDrift;
            this.volatility = data['volatility'] !== undefined
                ? data['volatility'] : GeometricBrownianMotionParameters.defaultVolatility;
            this.normalRandomGeneratorKind = data['normalRandomGeneratorKind'] !== undefined
                ? data['normalRandomGeneratorKind'] : GeometricBrownianMotionParameters.defaultNormalRandomGeneratorKind;
            ...
            this.seed = data['seed'] !== undefined
                ? data['seed'] : GeometricBrownianMotionParameters.defaultSeed;
        }
    }
