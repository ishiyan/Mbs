...
{
    [TestClass]
    public class ChirpOhlcvGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void ChirpOhlcvGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new ChirpOhlcvGeneratorParametersExampleProvider().GetExamples();
