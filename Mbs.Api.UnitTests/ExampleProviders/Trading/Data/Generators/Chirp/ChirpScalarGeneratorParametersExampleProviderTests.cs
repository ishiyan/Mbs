...
{
    [TestClass]
    public class ChirpScalarGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void ChirpScalarGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new ChirpScalarGeneratorParametersExampleProvider().GetExamples();
