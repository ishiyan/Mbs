...
{
    [TestClass]
    public class ChirpTradeGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void ChirpTradeGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new ChirpTradeGeneratorParametersExampleProvider().GetExamples();
