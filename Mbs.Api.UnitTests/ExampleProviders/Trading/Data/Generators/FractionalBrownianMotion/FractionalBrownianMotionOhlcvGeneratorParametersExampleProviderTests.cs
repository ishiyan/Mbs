...
{
    [TestClass]
    public class FractionalBrownianMotionOhlcvGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void FractionalBrownianMotionOhlcvGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new FractionalBrownianMotionOhlcvGeneratorParametersExampleProvider().GetExamples();
