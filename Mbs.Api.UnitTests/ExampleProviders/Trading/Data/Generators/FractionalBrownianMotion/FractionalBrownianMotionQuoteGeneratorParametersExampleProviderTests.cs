...
{
    [TestClass]
    public class FractionalBrownianMotionQuoteGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void FractionalBrownianMotionQuoteGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new FractionalBrownianMotionQuoteGeneratorParametersExampleProvider().GetExamples();
