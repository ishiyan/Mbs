...
{
    [TestClass]
    public class FractionalBrownianMotionScalarGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void FractionalBrownianMotionScalarGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new FractionalBrownianMotionScalarGeneratorParametersExampleProvider().GetExamples();
