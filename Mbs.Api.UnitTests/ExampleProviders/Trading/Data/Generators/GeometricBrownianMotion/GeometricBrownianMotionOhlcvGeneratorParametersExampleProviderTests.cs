...
{
    [TestClass]
    public class GeometricBrownianMotionOhlcvGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void GeometricBrownianMotionOhlcvGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new GeometricBrownianMotionOhlcvGeneratorParametersExampleProvider().GetExamples();
