...
{
    [TestClass]
    public class GeometricBrownianMotionQuoteGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void GeometricBrownianMotionQuoteGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new GeometricBrownianMotionQuoteGeneratorParametersExampleProvider().GetExamples();
