...
{
    [TestClass]
    public class GeometricBrownianMotionTradeGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void GeometricBrownianMotionTradeGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new GeometricBrownianMotionTradeGeneratorParametersExampleProvider().GetExamples();
