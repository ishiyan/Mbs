...
{
    [TestClass]
    public class MultiSinusoidalOhlcvGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void MultiSinusoidalOhlcvGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new MultiSinusoidalOhlcvGeneratorParametersExampleProvider().GetExamples();
