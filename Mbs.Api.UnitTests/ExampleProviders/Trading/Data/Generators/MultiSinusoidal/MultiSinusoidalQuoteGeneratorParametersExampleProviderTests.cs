...
{
    [TestClass]
    public class MultiSinusoidalQuoteGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void MultiSinusoidalQuoteGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new MultiSinusoidalQuoteGeneratorParametersExampleProvider().GetExamples();
