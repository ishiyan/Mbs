...
{
    [TestClass]
    public class MultiSinusoidalScalarGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void MultiSinusoidalScalarGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new MultiSinusoidalScalarGeneratorParametersExampleProvider().GetExamples();
