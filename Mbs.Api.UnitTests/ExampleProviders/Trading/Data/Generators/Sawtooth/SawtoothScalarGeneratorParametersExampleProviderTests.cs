...
{
    [TestClass]
    public class SawtoothScalarGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void SawtoothScalarGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new SawtoothScalarGeneratorParametersExampleProvider().GetExamples();
