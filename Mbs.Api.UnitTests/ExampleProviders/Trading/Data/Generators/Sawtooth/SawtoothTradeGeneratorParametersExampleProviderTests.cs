...
{
    [TestClass]
    public class SawtoothTradeGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void SawtoothTradeGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new SawtoothTradeGeneratorParametersExampleProvider().GetExamples();
