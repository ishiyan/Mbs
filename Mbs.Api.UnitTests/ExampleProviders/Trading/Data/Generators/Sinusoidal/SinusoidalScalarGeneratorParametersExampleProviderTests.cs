...
{
    [TestClass]
    public class SinusoidalScalarGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void SinusoidalScalarGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new SinusoidalScalarGeneratorParametersExampleProvider().GetExamples();
