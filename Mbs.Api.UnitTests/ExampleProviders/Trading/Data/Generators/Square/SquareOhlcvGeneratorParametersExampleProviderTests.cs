...
{
    [TestClass]
    public class SquareOhlcvGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void SquareOhlcvGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new SquareOhlcvGeneratorParametersExampleProvider().GetExamples();
