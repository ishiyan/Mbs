...
{
    [TestClass]
    public class SquareScalarGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void SquareScalarGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new SquareScalarGeneratorParametersExampleProvider().GetExamples();
