...
namespace Mbs.Api.UnitTests.ExampleProviders.Trading.Data.Generators.Square
{
    ...
    public class SquareTradeGeneratorOutputExampleProviderTests
    {
        ...
        public void SquareTradeGeneratorOutputExampleProvider_GetExamples_CorrectValues()
        {
            ...
            Assert.AreEqual(SquareTradeGeneratorOutputExampleProvider.Price1, example.Data[0].Price, "data[0] price");
            Assert.AreEqual(DefaultParameterValues.TradeVolume, example.Data[0].Volume, "data[0] volume");

            Assert.AreEqual(SquareTradeGeneratorOutputExampleProvider.Price2, example.Data[1].Price, "data[1] price");
