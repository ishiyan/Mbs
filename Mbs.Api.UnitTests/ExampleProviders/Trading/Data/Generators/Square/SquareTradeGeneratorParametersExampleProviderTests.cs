...
{
    [TestClass]
    public class SquareTradeGeneratorParametersExampleProviderTests
    {
        // ReSharper disable InconsistentNaming
        [TestMethod]
        public void SquareTradeGeneratorParametersExampleProvider_GetExamples_CorrectValues()
        {
            var example = new SquareTradeGeneratorParametersExampleProvider().GetExamples();
