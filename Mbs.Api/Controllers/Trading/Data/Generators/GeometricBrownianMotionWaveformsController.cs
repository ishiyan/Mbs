...
{
    /// <summary>
    /// Generates geometric Brownian motion waveforms.
    /// </summary>
    ...
    public class GeometricBrownianMotionWaveformsController : ControllerBase
    {
        private const string BaseUri = Constants.ApiVersionOneSegment + Constants.DataGenerationSegment + "GbmWaveforms";

        /// <summary>
        /// Generates a series of candlesticks which follow a geometric Brownian motion waveform.
        /// </summary>
        /// <remarks>
        /// The geometric Brownian motion *Ohlcv* waveform generator produces candlesticks with the following traits.
        ///
        /// 1. The mid prices of the candlesticks form a geometric Brownian motion defined by the Hurst exponent, amplitude and range.
        ///
        /// 2. The geometric Brownian motion is shifted upwards so it has minimal values at the specified minimal price level.
        ///
        ...
        /// 3. **drift**:                                The drift (the expected return), μ, of the geometric Brownian motion.
        /// The model assumes the value will "drift" up by the expected return, being shocked (added or subtracted) by a random shock.
        /// 4. **volatility**:                           The volatility (standard deviation), σ, of the geometric Brownian motion.
        ...
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(GeometricBrownianMotionOhlcvGeneratorOutputExampleProvider))]
        ...
        public async Task<IActionResult> GenerateOhlcvAsync([FromBody]GeometricBrownianMotionOhlcvGeneratorParameters parameters)
        {
        ...
        /// <summary>
        /// Generates a series of quotes which follow a geometric Brownian motion waveform.
        /// </summary>
        /// <remarks>
        /// The geometric Brownian motion *Quote* waveform generator produces quotes with the following traits.
        ///
        /// 1. The mid prices of the quotes form a geometric Brownian motion defined by the Hurst exponent, amplitude and range.
        ///
        /// 2. The geometric Brownian motion is shifted upwards so it has minimal values at the specified minimal price level.
        ///
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(GeometricBrownianMotionQuoteGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Quote>))]
        public async Task<IActionResult> GenerateQuoteAsync([FromBody]GeometricBrownianMotionQuoteGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
                return BadRequest(new InternalError(ModelState));
        ...
        /// <summary>
        /// Generates a series of trades which follow a geometric Brownian motion waveform.
        /// </summary>
        /// <remarks>
        /// The geometric Brownian motion *Trade* waveform generator produces trades with the following traits.
        ///
        /// 1. The prices of the trades form a geometric Brownian motion defined by the Hurst exponent, amplitude and range.
        ///
        /// 2. The geometric Brownian motion is shifted upwards so it has minimal values at the specified minimal price level.
        ///
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(GeometricBrownianMotionTradeGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Trade>))]
        public async Task<IActionResult> GenerateTradeAsync([FromBody]GeometricBrownianMotionTradeGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
                return BadRequest(new InternalError(ModelState));
        ...
        /// <summary>
        /// Generates a series of scalars which follow a geometric Brownian motion waveform.
        /// </summary>
        /// <remarks>
        /// The geometric Brownian motion *Scalar* waveform generator produces scalars with the following traits.
        ///
        /// 1. The values of the scalars form a geometric Brownian motion defined by the Hurst exponent, amplitude and range.
        ///
        /// 2. The geometric Brownian motion is shifted upwards so it has minimal values at the specified minimal value level.
        ///
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(GeometricBrownianMotionScalarGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Scalar>))]
        public async Task<IActionResult> GenerateScalarAsync([FromBody]GeometricBrownianMotionScalarGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
                return BadRequest(new InternalError(ModelState));
