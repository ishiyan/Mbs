...
{
    /// <summary>
    /// Generates a multi-sinusoidal waveform.
    /// </summary>
    ...
    public class MultiSinusoidalWaveformsController : ControllerBase
    {
        private const string BaseUri = Constants.ApiVersionOneSegment + Constants.DataGenerationSegment + "MultiSinusoidalWaveforms";

        /// <summary>
        /// Generates a series of candlesticks which follow a multi-sinusoidal waveform.
        /// </summary>
        /// <remarks>
        /// The multi-sinusoidal *Ohlcv* waveform generator produces candlesticks with the following traits.
        ///
        /// 1. The mid prices of the candlesticks form a sum of sinusoids defined by the given periods, amplitudes and phases.
        ///
        /// 2. The sum of sinusoids is shifted upwards so it has minimal values at the specified minimal price level.
        ///
        ...
        /// 1. **minimalValue**:              A minimal value of the combined sinusoids.
        /// 2. **multiSinusoidalComponents**: An array of parameters of individual sinusoids.
        /// 2.1. **amplitude**: An amplitude of a sinusoidal component, should be positive.
        /// 2.2. **period**:    A period of a sinusoidal component in samples, should be ≥ 2.
        /// 2.3. **phaseInPi**: A phase, φ, of a sinusoidal component in ratios of π; if φ∈[-1, 1], then the phase ∈[-π, π].
        ///
        ...
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(MultiSinusoidalOhlcvGeneratorOutputExampleProvider))]
        ...
        public async Task<IActionResult> GenerateOhlcvAsync([FromBody]MultiSinusoidalOhlcvGeneratorParameters parameters)
        {
        ...
        /// <summary>
        /// Generates a series of quotes which follow a multi-sinusoidal waveform.
        /// </summary>
        /// <remarks>
        /// The multi-sinusoidal *Quote* waveform generator produces quotes with the following traits.
        ///
        /// 1. The ask and bid prices are equidistant from the mid price.
        ...
        ///
        /// 2. The ask and bid sizes are constant values.
        ///
        /// The input parameters are as follows.
        ///
        /// ### Sample count ###
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(MultiSinusoidalQuoteGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Quote>))]
        public async Task<IActionResult> GenerateQuoteAsync([FromBody]MultiSinusoidalQuoteGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(new InternalError(ModelState));
        ...
        /// <summary>
        /// Generates a series of trades which follow a multi-sinusoidal waveform.
        /// </summary>
        /// <remarks>
        /// The multi-sinusoidal *Trade* waveform generator produces trades with the following traits.
        ///
        /// 1. The prices of the trades form a sum of sinusoids defined by the given periods, amplitudes and phases.
        ///
        /// 2. The sum of sinusoids is shifted upwards so it has minimal values at the specified minimal price level.
        ///
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(MultiSinusoidalTradeGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Trade>))]
        public async Task<IActionResult> GenerateTradeAsync([FromBody]MultiSinusoidalTradeGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(new InternalError(ModelState));
        ...
        /// <summary>
        /// Generates a series of scalars which follow a multi-sinusoidal waveform.
        /// </summary>
        /// <remarks>
        /// The multi-sinusoidal *Scalar* waveform generator produces scalars with the following traits.
        ///
        /// 1. The values of the scalars form a sum of sinusoids defined by the given periods, amplitudes and phases.
        ///
        /// 2. The sum of sinusoids is shifted upwards so it has minimal values at the specified minimal value level.
        ///
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(MultiSinusoidalScalarGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Scalar>))]
        public async Task<IActionResult> GenerateScalarAsync([FromBody]MultiSinusoidalScalarGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(new InternalError(ModelState));
