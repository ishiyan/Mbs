...
{
    /// <summary>
    /// Generates sawtooth impulse waveforms.
    /// </summary>
    ...
    public class SawtoothWaveformsController : ControllerBase
    {
        private const string BaseUri = Constants.ApiVersionOneSegment + Constants.DataGenerationSegment + "SawtoothWaveforms";

        /// <summary>
        /// Generates a series of candlesticks which follow a sawtooth impulse waveform.
        /// </summary>
        /// <remarks>
        /// The sawtooth impulse *Ohlcv* waveform generator produces candlesticks with the following traits.
        ///
        /// 1. The mid prices of the candlesticks form a sawtooth defined by the given amplitude and the length of the teeth.
        ///
        /// 2. The sawtooth is shifted upwards so it has minimal values at the specified minimal price level.
        ///
        ...
        ///
        /// ### Sawtooth parameters ###
        /// 1. **amplitude**:       An amplitude of the sawtooth impulse, should be positive.
        /// 2. **minimalValue**:    A minimum value of the sawtooth impulse, should be positive.
        /// 3. **isBiDirectional**: Whether a sawtooth impulse is reflected horizontally to form a triangle shape.
        /// 4. **shape**:           A sawtooth shape.
        ///
        ...
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(SawtoothOhlcvGeneratorOutputExampleProvider))]
        ...
        public async Task<IActionResult> GenerateOhlcvAsync([FromBody]SawtoothOhlcvGeneratorParameters parameters)
        {
        ...
        /// <summary>
        /// Generates a series of quotes which follow a sawtooth impulse waveform.
        /// </summary>
        /// <remarks>
        /// The sawtooth impulse *Quote* waveform generator produces quotes with the following traits.
        ///
        /// 1. The mid prices of the quotes form a sawtooth defined by the given amplitude and the length of the teeth.
        ///
        /// 2. The sawtooth is shifted upwards so it has minimal values at the specified minimal price level.
        ///
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(SawtoothQuoteGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Quote>))]
        public async Task<IActionResult> GenerateQuoteAsync([FromBody]SawtoothQuoteGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(new InternalError(ModelState));
        ...
        /// <summary>
        /// Generates a series of trades which follow a sawtooth impulse waveform.
        /// </summary>
        /// <remarks>
        /// The sawtooth impulse *Trade* waveform generator produces trades with the following traits.
        ///
        /// 1. The prices of the trades form a sawtooth impulses defined by the given amplitude and the length of the teeth.
        ///
        /// 2. The sawtooth impulse is shifted upwards so it has minimal values at the specified minimal price level.
        ///
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(SawtoothTradeGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Trade>))]
        public async Task<IActionResult> GenerateTradeAsync([FromBody]SawtoothTradeGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(new InternalError(ModelState));
        ...
        /// <summary>
        /// Generates a series of scalars which follow a sawtooth impulse waveform.
        /// </summary>
        /// <remarks>
        /// The sawtooth impulse *Scalar* waveform generator produces scalars with the following traits.
        ///
        /// 1. The values of the scalars form a sawtooth impulses defined by the given amplitude and the length of the tooth.
        ///
        /// 2. The sawtooth impulse is shifted upwards so it has minimal values at the specified minimal value level.
        ///
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(SawtoothScalarGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Scalar>))]
        public async Task<IActionResult> GenerateScalarAsync([FromBody]SawtoothScalarGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(new InternalError(ModelState));
