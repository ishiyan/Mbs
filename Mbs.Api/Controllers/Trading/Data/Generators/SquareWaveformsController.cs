...
{
    /// <summary>
    /// Generates square impulse waveforms.
    /// </summary>
    ...
    public class SquareWaveformsController : ControllerBase
    {
        private const string BaseUri = Constants.ApiVersionOneSegment + Constants.DataGenerationSegment + "SquareWaveforms";

        /// <summary>
        /// Generates a series of candlesticks which follow a square impulse waveform.
        /// </summary>
        /// <remarks>
        /// The square impulse *Ohlcv* waveform generator produces candlesticks with the following traits.
        ///
        /// 1. The mid prices of the candlesticks form a square impulses defined by the given amplitude and the length of the impulse.
        ///
        /// 2. The square impulse is shifted upwards so it has minimal values at the specified minimal price level.
        ///
        ...
        ///
        /// ### Square parameters ###
        /// 1. **amplitude**:       An amplitude of the square impulse, should be positive.
        /// 2. **minimalValue**:    The minimum value of a square impulse, should be positive.
        ///
        ...
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(SquareOhlcvGeneratorOutputExampleProvider))]
        ...
        public async Task<IActionResult> GenerateOhlcvAsync([FromBody]SquareOhlcvGeneratorParameters parameters)
        {
        ...
        /// <summary>
        /// Generates a series of quotes which follow a square impulse waveform.
        /// </summary>
        /// <remarks>
        /// The square impulse *Quote* waveform generator produces quotes with the following traits.
        ///
        /// 1. The mid prices of the quotes form a square impulses defined by the given amplitude and the length of the impulse.
        ///
        /// 2. The square impulse is shifted upwards so it has minimal values at the specified minimal price level.
        ///
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(SquareQuoteGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Quote>))]
        public async Task<IActionResult> GenerateQuoteAsync([FromBody]SquareQuoteGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(new InternalError(ModelState));
        ...
        /// <summary>
        /// Generates a series of trades which follow a square impulse waveform.
        /// </summary>
        /// <remarks>
        /// The square impulse *Trade* waveform generator produces trades with the following traits.
        ///
        /// 1. The prices of the trades form a square impulses defined by the given amplitude and the length of the impulse.
        ///
        /// 2. The square impulse is shifted upwards so it has minimal values at the specified minimal price level.
        ///
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(SquareTradeGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Trade>))]
        public async Task<IActionResult> GenerateTradeAsync([FromBody]SquareTradeGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(new InternalError(ModelState));
        ...
        /// <summary>
        /// Generates a series of scalars which follow a square impulse waveform.
        /// </summary>
        /// <remarks>
        /// The square impulse *Scalar* waveform generator produces scalars with the following traits.
        ///
        /// 1. The values of the scalars form a square impulses defined by the given amplitude and the length of the impulse.
        ///
        /// 2. The square impulse is shifted upwards so it has minimal values at the specified minimal value level.
        ///
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(InternalError))]
        [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(InternalError))]
        [SwaggerResponseExample(StatusCodes.Status200OK, typeof(SquareScalarGeneratorOutputExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status400BadRequest, typeof(WaveformDataGeneratorBadRequestExampleProvider))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(InternalErrorExampleProvider))]
        [Produces(typeof(SyntheticDataGeneratorOutput<Scalar>))]
        public async Task<IActionResult> GenerateScalarAsync([FromBody]SquareScalarGeneratorParameters parameters)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(new InternalError(ModelState));
