...
{
    /// <inheritdoc />
    internal class ChirpQuoteGeneratorParametersExampleProvider : IExamplesProvider<ChirpQuoteGeneratorParameters>
    {
        /// <inheritdoc />
        public ChirpQuoteGeneratorParameters GetExamples()
        {
            return new ChirpQuoteGeneratorParameters
            {
