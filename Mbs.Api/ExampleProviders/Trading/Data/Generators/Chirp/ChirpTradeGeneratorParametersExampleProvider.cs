...
{
    /// <inheritdoc />
    internal class ChirpTradeGeneratorParametersExampleProvider : IExamplesProvider<ChirpTradeGeneratorParameters>
    {
        /// <inheritdoc />
        public ChirpTradeGeneratorParameters GetExamples()
        {
            return new ChirpTradeGeneratorParameters
            {
