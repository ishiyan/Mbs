...
{
    /// <inheritdoc />
    internal class FractionalBrownianMotionScalarGeneratorParametersExampleProvider : IExamplesProvider<FractionalBrownianMotionScalarGeneratorParameters>
    {
        /// <inheritdoc />
        public FractionalBrownianMotionScalarGeneratorParameters GetExamples()
        {
            return new FractionalBrownianMotionScalarGeneratorParameters
            {
