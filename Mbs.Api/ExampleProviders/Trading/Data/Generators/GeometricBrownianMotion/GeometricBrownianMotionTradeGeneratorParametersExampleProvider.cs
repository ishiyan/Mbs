...
{
    /// <inheritdoc />
    internal class GeometricBrownianMotionTradeGeneratorParametersExampleProvider : IExamplesProvider<GeometricBrownianMotionTradeGeneratorParameters>
    {
        /// <inheritdoc />
        public GeometricBrownianMotionTradeGeneratorParameters GetExamples()
        {
            return new GeometricBrownianMotionTradeGeneratorParameters
            {
