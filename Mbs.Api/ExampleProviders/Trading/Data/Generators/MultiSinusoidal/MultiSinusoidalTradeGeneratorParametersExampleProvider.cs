...
{
    /// <inheritdoc />
    internal class MultiSinusoidalTradeGeneratorParametersExampleProvider : IExamplesProvider<MultiSinusoidalTradeGeneratorParameters>
    {
        /// <inheritdoc />
        public MultiSinusoidalTradeGeneratorParameters GetExamples()
        {
            return new MultiSinusoidalTradeGeneratorParameters
            {
