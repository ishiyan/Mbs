...
{
    /// <inheritdoc />
    internal class SawtoothOhlcvGeneratorParametersExampleProvider : IExamplesProvider<SawtoothOhlcvGeneratorParameters>
    {
        /// <inheritdoc />
        public SawtoothOhlcvGeneratorParameters GetExamples()
        {
            return new SawtoothOhlcvGeneratorParameters
            {
