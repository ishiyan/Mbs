...
namespace Mbs.UnitTests.Numerics.RandomGenerators
{
    ...
    public class AdditiveLaggedFibonacciUniformRandomTests
    {
        ...
        [TestMethod]
        public void AdditiveLaggedFibonacciUniformRandom_NextDouble_GeneratedMany_MeanHasCorrectValue_()
        {
        ...
        [TestMethod]
        public void AdditiveLaggedFibonacciUniformRandom_NextInt_GeneratedMany_MeanHasCorrectValue_()
        {
            var gen = new AdditiveLaggedFibonacciUniformRandom(Seed);
        ...
        [TestMethod]
        public void AdditiveLaggedFibonacciUniformRandom_NextBoolean_GeneratedMany_MeanHasCorrectValue_()
        {
            var gen = new AdditiveLaggedFibonacciUniformRandom(Seed);
        ...
        [TestMethod]
        public void AdditiveLaggedFibonacciUniformRandom_NextBytes_GeneratedMany_MeanHasCorrectValue_()
        {
            var gen = new AdditiveLaggedFibonacciUniformRandom(Seed);
