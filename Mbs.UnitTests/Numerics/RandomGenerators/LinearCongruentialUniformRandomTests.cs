...
namespace Mbs.UnitTests.Numerics.RandomGenerators
{
    ...
    public class LinearCongruentialUniformRandomTests
    {
        ...
        [TestMethod]
        public void LinearCongruentialUniformRandom_NextDouble_GeneratedMany_MeanHasCorrectValue_()
        {
        ...
        [TestMethod]
        public void LinearCongruentialUniformRandom_NextInt_GeneratedMany_MeanHasCorrectValue_()
        {
            var gen = new LinearCongruentialUniformRandom(Seed);
        ...
        [TestMethod]
        public void LinearCongruentialUniformRandom_NextBoolean_GeneratedMany_MeanHasCorrectValue_()
        {
            var gen = new LinearCongruentialUniformRandom(Seed);
        ...
        [TestMethod]
        public void LinearCongruentialUniformRandom_NextBytes_GeneratedMany_MeanHasCorrectValue_()
        {
            var gen = new LinearCongruentialUniformRandom(Seed);
