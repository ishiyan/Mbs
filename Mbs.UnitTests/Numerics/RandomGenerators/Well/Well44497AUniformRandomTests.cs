...
{
    [TestClass]
    public class Well44497AUniformRandomTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void Well44497AUniformRandom_NextUInt_ApacheJavaTest()
        {
            var init = new int[44497];
            ...
            var gen = new Well44497AUniformRandom(init);
            for (int i = 0; i < length; ++i)
            {
                uint expected = (uint)ExpectedInt[i];
        ...
        [TestMethod]
        public void Well44497AUniformRandom_NextUInt_BoostReferenceImplementationTest()
        {
            var init = new int[44497];
            for (int i = 0; i < init.Length; ++i)
            {
            ...
            const uint expected = 0xfdd7c07bU;
            Assert.AreEqual(expected, actual,
                Invariant($"Boost reference implementation uint: actual={actual} expected={expected}"));
        }

        [TestMethod]
        public void Well44497AUniformRandom_NextDouble_GeneratedMany_MeanHasCorrectValue()
        {
            var gen = new Well44497AUniformRandom(Seed);
            double expected = 0.5;
        ...
        [TestMethod]
        public void Well44497AUniformRandom_NextInt_GeneratedMany_MeanHasCorrectValue()
        {
            var gen = new Well44497AUniformRandom(Seed);
        ...
        [TestMethod]
        public void Well44497AUniformRandom_NextBoolean_GeneratedMany_MeanHasCorrectValue()
        {
            var gen = new Well44497AUniformRandom(Seed);
        ...
        [TestMethod]
        public void Well44497AUniformRandom_NextBytes_GeneratedMany_MeanHasCorrectValue()
        {
            var gen = new Well44497AUniformRandom(Seed);
        ...
        [TestMethod]
        public void Well44497AUniformRandom_Seed_SameSeed_SameValue()
        {
            var gen1 = new Well44497AUniformRandom(Seed);
            int expected = gen1.NextInt();

            var gen2 = new Well44497AUniformRandom(Seed);
        ...
        [TestMethod]
        public void Well44497AUniformRandom_Seed_DifferentSeed_DifferentValue()
        {
            var gen1 = new Well44497AUniformRandom(Seed);
            int expected = gen1.NextInt();

            var gen2 = new Well44497AUniformRandom(Seed + 1);
            int actual = gen2.NextInt();
        ...
        [TestMethod]
        public void Well44497AUniformRandom_CanReset_ReturnsTrue()
        {
            var gen = new Well44497AUniformRandom();

            Assert.IsTrue(gen.CanReset);
        }

        [TestMethod]
        public void Well44497AUniformRandom_Reset_ValueGeneratedThenReset_SameValueGenerated()
        {
            var gen = new Well44497AUniformRandom();
