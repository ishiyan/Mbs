...
namespace Mbs.UnitTests.Trading.Currencies
{
    ...
    public class FixedRateCurrencyConverterTests
    {
        ...
        public void FixedRateCurrencyConverter_RateSubscribe_ExchangeRateSet_CorrectRateHistoryReported()
        {
            ...
            Action<double> action = expected.Add;
            var cc = new FixedRateCurrencyConverter();
            Assert.AreEqual(0d, cc.ExchangeRate(CurrencyCode.Nok, CurrencyCode.Dkk));
            Assert.AreEqual(0d, cc.ExchangeRate(CurrencyCode.Nok, CurrencyCode.Sek));

            cc.RateSubscribe(CurrencyCode.Nok, CurrencyCode.Dkk, action);
            cc.RateSubscribe(CurrencyCode.Nok, CurrencyCode.Sek, action);
            ...
            cc.RateUnsubscribe(CurrencyCode.Nok, CurrencyCode.Dkk, action);
            ...
            Assert.AreEqual(1.1, expected[0]);
            Assert.AreEqual(2.1, expected[1]);
            Assert.AreEqual(1.2, expected[2]);
            Assert.AreEqual(1.2, expected[3]);
            Assert.AreEqual(1.3, expected[4]);
            Assert.AreEqual(2.2, expected[5]);
            Assert.AreEqual(2.3, expected[6]);
        }
        ...
        public void FixedRateCurrencyConverter_RateUnsubscribe_ExchangeRateSet_CorrectRateHistoryReported()
        {
            ...
            Assert.AreEqual(7, expected.Count);
            Assert.AreEqual(1.2, expected[0]);
            Assert.AreEqual(1.4, expected[1]);
            Assert.AreEqual(1.5, expected[2]);
            Assert.AreEqual(1.5, expected[3]);
            Assert.AreEqual(1.6, expected[4]);
            Assert.AreEqual(1.6, expected[5]);
            Assert.AreEqual(1.6, expected[6]);
        }
        ...
        public void FixedRateCurrencyConverter_ExchangeRate_ExchangeRateSet_CorrectRateReturned()
        {
            ...
            var cc = new FixedRateCurrencyConverter();
            Assert.AreEqual(0d, cc.ExchangeRate(CurrencyCode.Nok, CurrencyCode.Dkk));
            Assert.AreEqual(0d, cc.ExchangeRate(CurrencyCode.Dkk, CurrencyCode.Nok));
            ...
            Assert.AreEqual(0d, cc.ExchangeRate(CurrencyCode.Dkk, CurrencyCode.Nok));
            Assert.AreEqual(0d, cc.ExchangeRate(CurrencyCode.Sek, CurrencyCode.Nok));
        ...
        public void FixedRateCurrencyConverter_Convert_ExchangeRateSet_CorrectConversionReturned()
        {
            ...
            var cc = new FixedRateCurrencyConverter();
            Assert.AreEqual(0d, cc.Convert(amount1, CurrencyCode.Nok, CurrencyCode.Dkk));
            Assert.AreEqual(0d, cc.Convert(amount2, CurrencyCode.Dkk, CurrencyCode.Nok));
