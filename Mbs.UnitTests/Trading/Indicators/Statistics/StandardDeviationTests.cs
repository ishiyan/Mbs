...
namespace Mbs.UnitTests.Trading.Indicators.Statistics
{
    ...
    public class StandardDeviationTests
    {
        ...
        /// <summary>
        /// Excel (STDEV.P) output of standard deviation based on population variance of length 5.
        /// </summary>
        private static readonly double[] PopulationStdev5Expected =
        {
        ...
        /// <summary>
        /// Excel (STDEV.S) output of standard deviation based on sample variance of length 5.
        /// </summary>
        private static readonly double[] SampleStdev5Expected =
        {
            double.NaN, double.NaN, double.NaN, double.NaN,
        ...
        public void StandardDeviation_Metadata_ValuesAreCorrect()
        {
            ...
            Assert.AreEqual(IndicatorType.StandardDeviation, metadata.IndicatorType);
            Assert.IsNotNull(metadata.Outputs);
            Assert.AreEqual(1, metadata.Outputs.Length);
            Assert.AreEqual((int)StandardDeviation.OutputKind.Value, metadata.Outputs[0].Kind);
        ...
        public void StandardDeviation_Metadata_SampleVariance_NameAndDescriptionAreCorrect()
        {
            ...
            Assert.AreEqual("stdev.s(7,c)", metadata.Outputs[0].Name);
            Assert.AreEqual("Standard deviation based on sample variance stdev.s(7,c)", metadata.Outputs[0].Description);
        }
        ...
        public void StandardDeviation_Metadata_PopulationVariance_NameAndDescriptionAreCorrect()
        {
            ...
            Assert.AreEqual("stdev.p(7,c)", metadata.Outputs[0].Name);
            Assert.AreEqual("Standard deviation based on population variance stdev.p(7,c)", metadata.Outputs[0].Description);
        }

        [TestMethod]
        public void StandardDeviation_Update_PopulationVariance_Single_ReturnsCorrectValues()
        {
            ...
            for (int i = 4; i < count; ++i)
            {
                ...
                output = target.Update(scalar);
                scalar = (Scalar)output.Outputs[0];
                Assert.AreEqual(Math.Round(PopulationStdev5Expected[i], Decimals), Math.Round(scalar.Value, Decimals));
            }
        }

        [TestMethod]
        public void StandardDeviation_Update_PopulationVariance_Collection_ReturnsCorrectValues()
        {
            int count = StdevInput.Length;
        ...
        [TestMethod]
        public void StandardDeviation_Update_SampleVariance_Single_ReturnsCorrectValues()
        {
            IndicatorOutput output;
            var scalar = new Scalar(DateTime.Now, 1d);
            int count = StdevInput.Length;
            ...
            for (int i = 4; i < count; ++i)
            {
                ...
                output = target.Update(scalar);
                scalar = (Scalar)output.Outputs[0];
                Assert.AreEqual(Math.Round(SampleStdev5Expected[i], Decimals), Math.Round(scalar.Value, Decimals));
            }
        }

        [TestMethod]
        public void StandardDeviation_Update_SampleVariance_Collection_ReturnsCorrectValues()
        {
            int count = StdevInput.Length;
            var scalarArray = new Scalar[count];
            for (int i = 0; i < count; ++i)
        ...
        [TestMethod]
        public void StandardDeviation_UpdateSample_ReturnsTheSameValuesAsUpdate()
        {
            var scalar = new Scalar(DateTime.Now, 1d);
            int count = StdevInput.Length;
            ...
            for (int i = 0; i < 4; ++i)
            {
                ...
                var d = target2.UpdateSample(StdevInput[i]);
        ...
        [TestMethod]
        public void StandardDeviation_Reset_FunctionsCorrectly()
        {
            IndicatorOutput output;
            var scalar = new Scalar(DateTime.Now, 1d);
            int count = StdevInput.Length;
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void StandardDeviation_Constructor_LengthIsZero_ThrowsException()
        {
            var parameters = new StandardDeviation.Parameters();
