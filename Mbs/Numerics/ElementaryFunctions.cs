...
namespace Mbs.Numerics
{
    ...
    /// </summary>
    public static partial class ElementaryFunctions
    {
        /// <summary>
        ...
        {
            2.1664791066439526, -0.28565398551049742, 0.015177672556905537, -0.0020021590494141545, 0.00019211375164056698, -2.5532588861055426E-05, 2.9004512660400622E-06, -3.8873813517057341E-07, 4.7743678729400456E-08, -6.4501969776090321E-09, 8.2751976628812384E-10, -1.126049937649205E-10, 1.4844576692270934E-11, -2.0328515972462118E-12, 2.7291231220549217E-13, -3.7581977830387938E-14,
            5.1107345870861672E-15, -7.0722150011433277E-16, 9.7089758328248469E-17, -1.3492637457521938E-17, 1.8657327910677295E-18
        };
        ...
        public static double Log1PlusX(double x)
        {
            if (double.IsNaN(x))
                return x;
            if (x <= -1d)
                return double.NaN; // throw new ArgumentOutOfRangeException("x", "The value must be greater than -1.");
            double num = x * x;
            ...
            return x * SpecialFunctions.EvaluateChebyshevSeries((8d * x + 1.0) / (2d * (x + 2d)), Log1PxExpansion);
        }
