...
namespace Mbs.Numerics.RandomGenerators.MersenneTwister
{
    ...
    public sealed class MersenneTwister11213BUniformRandom : RandomGenerator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MersenneTwister11213BUniformRandom"/> class,
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="MersenneTwister11213BUniformRandom"/> can be reset,
        /// so that it produces the same pseudo-random number sequence again.
        /// </summary>
        public override bool CanReset => true;

        /// <summary>
        /// Resets the <see cref="MersenneTwister11213BUniformRandom"/>,
        /// so that it produces the same pseudo-random number sequence again.
        /// </summary>
