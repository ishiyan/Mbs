...
namespace Mbs.Numerics.Random
{
    ...
    public sealed class MersenneTwisterSfmt216091UniformRandom : MersenneTwisterSfmtEngine
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MersenneTwisterSfmt216091UniformRandom"/> class, using the specified seed value.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MersenneTwisterSfmt216091UniformRandom"/> class, using the specified seed array.
        /// </summary>
