...
namespace Mbs.Numerics.Random
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MersenneTwisterSfmt4253UniformRandom"/> class, using the current system tick count as a seed value.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MersenneTwisterSfmt4253UniformRandom"/> class, using the specified seed value.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MersenneTwisterSfmt4253UniformRandom"/> class, using the specified seed array.
        /// </summary>
