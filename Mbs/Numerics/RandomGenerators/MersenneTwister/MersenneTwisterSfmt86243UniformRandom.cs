...
namespace Mbs.Numerics.Random
{
    ...
    public sealed class MersenneTwisterSfmt86243UniformRandom : MersenneTwisterSfmtEngine
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MersenneTwisterSfmt86243UniformRandom"/> class, using the specified seed value.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MersenneTwisterSfmt86243UniformRandom"/> class, using the specified seed array.
        /// </summary>
