...
namespace Mbs.Numerics.RandomGenerators.Other
{
    ...
    public sealed class LinearCongruentialUniformRandom : RandomGenerator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LinearCongruentialUniformRandom"/> class,
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="LinearCongruentialUniformRandom"/> can be reset,
        /// so that it produces the same pseudo-random number sequence again.
        /// </summary>
        public override bool CanReset => true;

        /// <summary>
        /// Resets the <see cref="LinearCongruentialUniformRandom"/>,
        /// so that it produces the same pseudo-random number sequence again.
        /// </summary>
