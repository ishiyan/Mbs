namespace Mbs.Numerics.RandomGenerators.Well
{
    ...
    /// </summary>
    public sealed class Well19937CUniformRandom : WellEngine
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Well19937CUniformRandom"/> class.
        /// </summary>
        public Well19937CUniformRandom()
            : base(K, M1, M2, M3)
        {
        }
        ...
        public Well19937CUniformRandom(int seed)
        ...
        /// </summary>
        /// <param name="seed">The initial seed value.</param>
        public Well19937CUniformRandom(long seed)
            : base(K, M1, M2, M3, seed)
        {
        }
        ...
        public Well19937CUniformRandom(int[] seedArray)
