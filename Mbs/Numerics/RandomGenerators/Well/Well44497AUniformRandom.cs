...
{
    /// <summary>
    /// The Well44497a pseudo-random number generator as described in a paper by François Panneton, Pierre L'Ecuyer and Makoto Matsumoto.
    /// <para />
    ...
    /// </summary>
    public sealed class Well44497AUniformRandom : WellEngine
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Well44497AUniformRandom"/> class.
        /// </summary>
        public Well44497AUniformRandom()
            : base(K, M1, M2, M3)
        {
        }
        ...
        public Well44497AUniformRandom(int seed)
        ...
        /// </summary>
        /// <param name="seed">The initial seed value.</param>
        public Well44497AUniformRandom(long seed)
            : base(K, M1, M2, M3, seed)
        {
        }
        ...
        public Well44497AUniformRandom(int[] seedArray)
        ...
        public override uint NextUInt()
        {
            ...
            V[Index] = z3;
            V[indexRm1] = z4;
            V[indexRm2] = V[indexRm2] & 0xFFFF8000U;
            Index = indexRm1;
