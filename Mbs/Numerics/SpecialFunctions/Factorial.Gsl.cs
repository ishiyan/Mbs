...
namespace Mbs.Numerics
{
    ...
    public static partial class SpecialFunctions
    {
        ...
        public static partial class Gsl
        {
            ...
            /// <seealso href="http://mathworld.wolfram.com/DoubleFactorial.html"/>
            public static double LnDoubleFactE(int n)
            {
                if (n < 0)
                    return double.NaN;
                double value;
            ...
            /// <returns>The number of ways of picking <c>k</c> unordered outcomes from <c>n</c> possibilities.</returns>
            // ReSharper disable once MemberHidesStaticFromOuterClass
            public static double BinomialCoefficient(int n, int k)
            {
                    ...
                    return (Factorials[n] / Factorials[k]) / Factorials[n - k];
                {
                    ...
                    double value = LnBinomialCoefficient(n, k);
            ...
            public static double LnBinomialCoefficient(int n, int k)
            {
                if (k > n)
                    return double.NaN;
                if (k == n || k == 0)
...
#pragma warning disable SA1025 // Code must not contain multiple whitespace in a row
            ...
            /// </summary>
            internal static readonly double[] Factorials =
            {
                1.0,                                     // 0
                1.0,                                     // 1
                2.0,                                     // 2
