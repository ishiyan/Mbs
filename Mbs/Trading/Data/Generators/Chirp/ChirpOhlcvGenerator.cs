...
{
    /// <summary>
    /// The chirp <see cref="Ohlcv"/> waveform (a period-swept cosine wave) generator produces candlesticks with the following traits.
    /// <para/>➊ The mid prices of the candlesticks form a period-swept cosine wave defined by the given begin/end periods, amplitude and phase.
    ...
    public sealed class ChirpOhlcvGenerator : ChirpDataGenerator<Ohlcv>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChirpOhlcvGenerator"/> class.
        /// </summary>
        /// <param name="parameters">The input parameters.</param>
        public ChirpOhlcvGenerator(ChirpOhlcvGeneratorParameters parameters)
        ...
        /// <param name="sampleMinimum">The sample value corresponding to the minimum of the chirp, should be positive.</param>
