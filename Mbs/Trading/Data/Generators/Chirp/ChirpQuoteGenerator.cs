...
{
    /// <summary>
    /// The chirp <see cref="Quote"/> waveform (a period-swept cosine wave) generator produces quotes with the following traits.
    /// <para/>➊ The mid prices of the quotes form a chirp defined by the given begin/end periods, amplitude and phase.
    ...
    /// </summary>
    public sealed class ChirpQuoteGenerator : ChirpDataGenerator<Quote>
    {
        internal const string WaveformName = "Chirp quote waveform";

        /// <summary>
        /// Initializes a new instance of the <see cref="ChirpQuoteGenerator"/> class.
        /// </summary>
        /// <param name="parameters">The input parameters.</param>
        public ChirpQuoteGenerator(ChirpQuoteGeneratorParameters parameters)
