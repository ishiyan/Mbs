...
{
    /// <summary>
    /// The input parameters for the <see cref="Quote"/> fractional Brownian motion generator.
    /// </summary>
    public class FractionalBrownianMotionQuoteGeneratorParameters : IValidatableObject
    {
        /// <summary>
