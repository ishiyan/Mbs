...
{
    /// <summary>
    /// The input parameters for the <see cref="Scalar"/> fractional Brownian motion generator.
    /// </summary>
    public class FractionalBrownianMotionScalarGeneratorParameters : IValidatableObject
    {
        /// <summary>
