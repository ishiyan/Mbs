...
{
    /// <summary>
    /// The input parameters for the <see cref="Trade"/> fractional Brownian motion generator.
    /// </summary>
    public class FractionalBrownianMotionTradeGeneratorParameters : IValidatableObject
    {
        /// <summary>
