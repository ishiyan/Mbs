...
{
    /// <summary>
    /// The input parameters for the <see cref="Quote"/> geometric Brownian motion generator.
    /// </summary>
    public class GeometricBrownianMotionQuoteGeneratorParameters : IValidatableObject
    {
        /// <summary>
