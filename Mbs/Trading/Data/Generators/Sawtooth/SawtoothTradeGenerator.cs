...
{
    /// <summary>
    /// The sawtooth impulse waveform <see cref="Trade"/> generator produces trades with the following traits.
    /// <para/>➊ The prices of the trades form a sawtooth impulses defined by the given amplitude and the length of the teeth.
    /// <para/>➋ The sawtooth impulse is shifted upwards so it has minimal values at the specified minimal price level.
    /// <para/>➌ The volume has a constant value.
    /// <para/>➍ An optional noise may be added to the prices.
    /// </summary>
    public sealed class SawtoothTradeGenerator : SawtoothDataGenerator<Trade>
    {
        /// <summary>
        ...
        internal const string WaveformName = "Sawtooth trade waveform";

        /// <summary>
        /// Initializes a new instance of the <see cref="SawtoothTradeGenerator"/> class.
        /// </summary>
        /// <param name="parameters">The input parameters.</param>
        public SawtoothTradeGenerator(SawtoothTradeGeneratorParameters parameters)
