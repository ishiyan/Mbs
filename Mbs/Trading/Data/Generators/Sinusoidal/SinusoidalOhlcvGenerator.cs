...
{
    /// <summary>
    /// The sinusoidal <see cref="Ohlcv"/> waveform generator produces candlesticks with the following traits.
    /// <para/>➊ The mid prices of the candlesticks form a sinusoid defined by the given period, amplitude and phase.
    ...
    /// </summary>
    public sealed class SinusoidalOhlcvGenerator : SinusoidalDataGenerator<Ohlcv>
    {
        internal const string WaveformName = "Sinusoidal ohlcv waveform";

        private double midPricePrevious = double.NaN;

        /// <summary>
        /// Initializes a new instance of the <see cref="SinusoidalOhlcvGenerator"/> class.
        /// </summary>
        /// <param name="parameters">The input parameters.</param>
        public SinusoidalOhlcvGenerator(SinusoidalOhlcvGeneratorParameters parameters)
        ...
        public SinusoidalOhlcvGenerator(
