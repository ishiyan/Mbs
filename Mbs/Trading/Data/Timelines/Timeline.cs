...
namespace Mbs.Trading.Data.Timelines
{
    ...
    public sealed class Timeline
    {
            ...
            where T : TemporalEntity
        {
            ...
            /// </summary>
            internal readonly IHistoricalData<T> HistoricalData;
        ...
        {
            if (null != tradeEnumerableProviderCollection)
            {
                foreach (var v in tradeEnumerableProviderCollection)
                    Add(v);
            }

            if (null != quoteEnumerableProviderCollection)
            {
                foreach (var v in quoteEnumerableProviderCollection)
                    Add(v);
            }

            if (null != ohlcvEnumerableProviderCollection)
            {
                foreach (var v in ohlcvEnumerableProviderCollection)
                    Add(v);
            }

            if (null != scalarEnumerableProviderCollection)
            {
            ...
            where T : TemporalEntity
        {
            ...
            if (type == Types.OhlcvType)
            {
                ...
                lock (ohlcvSubscriptionProvidersDictionaryLock)
                {
                    if (!ohlcvSubscriptionProvidersDictionary.TryGetValue(sep, out TimelineSubscriptionProvider<Ohlcv> tsp))
            ...
            else if (type == Types.ScalarType)
            {
                ...
                lock (scalarSubscriptionProvidersDictionaryLock)
                {
                    if (!scalarSubscriptionProvidersDictionary.TryGetValue(sep, out TimelineSubscriptionProvider<Scalar> tsp))
            ...
            else if (type == Types.TradeType)
            {
                ...
                lock (tradeSubscriptionProvidersDictionaryLock)
                {
                    if (!tradeSubscriptionProvidersDictionary.TryGetValue(sep, out TimelineSubscriptionProvider<Trade> tsp))
            ...
            else if (type == Types.QuoteType)
            {
                ...
                lock (quoteSubscriptionProvidersDictionaryLock)
                {
                    if (!quoteSubscriptionProvidersDictionary.TryGetValue(sep, out TimelineSubscriptionProvider<Quote> tsp))
        ...
        public void Start()
        {
            ExecuteAction(() =>
            {
                ...
                lock (mergingEnumerableLock)
                {
                    ...
                    if (TimelineState.Stop != currentState)
        ...
        public void Stop()
        {
            ExecuteAction(() =>
            {
                ...
                {
                    TimelineState currentState = State;
                    if (TimelineState.Pause != currentState && TimelineState.Run != currentState)
        ...
        public void Pause()
        {
            ...
            {
                TimelineState currentState = State;
                if (TimelineState.Run != currentState)
        ...
        public void Step()
        {
            ExecuteAction(() =>
            {
                ...
                {
                    TimelineState currentState = State;
                    if (TimelineState.Pause != currentState && TimelineState.Stop != currentState)
        ...
        public void Continue()
        {
            ExecuteAction(() =>
            {
                ...
                {
                    TimelineState currentState = State;
                    if (TimelineState.Pause != currentState)
