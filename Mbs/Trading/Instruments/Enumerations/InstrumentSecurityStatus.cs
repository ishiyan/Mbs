...
#pragma warning disable CA1717 // Only FlagsAttribute enums should have plural names
    ...
    /// <remarks>
    /// <para>
    /// Modelled after FIX SecurityStatus field.
    /// </para>
    /// <para>
    ...
    public enum InstrumentSecurityStatus
    {
        ...
        /// </summary>
        /// <remarks>
        /// For example, a contract that expires intra-day (e.g. at noon time) and is no longer tradeable
        ...
        /// </para>
        /// <para>
        /// Delisting rules varies from exchange to exchange, which may include non-compliance of
