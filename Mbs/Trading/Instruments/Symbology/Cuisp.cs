namespace Mbs.Trading.Instruments
{
    ...
    /// </para>
    /// </remarks>
    public static class Cuisp
    {
        /// <summary>
        /// Checks for the validity of the given CUISP.
        /// </summary>
        /// <param name="cuisp">The CUISP.</param>
        /// <returns>True if CUISP is valid.</returns>
        public static bool IsValidCuisp(this string cuisp)
        {
        ...
        /// <param name="cuisp">The CUISP.</param>
        /// <returns>True if CUISP is valid.</returns>
        public static bool IsValidCuisp2(this string cuisp)
        {
