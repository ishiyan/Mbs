...
namespace Mbs.Trading.Time
{
    ...
    /// </summary>
    /// <remarks>
    /// Provedes a specific exchange holiday schedule or a general country holiday schedule, which
        ...
        public static Func<DateTime, bool> BusinessHolidayPredicate(this BusinessDayCalendar calendar)
        {
            switch (calendar)
            {
                case BusinessDayCalendar.Target:
                    return dateTime => dateTime.IsTargetHoliday();
                case BusinessDayCalendar.WeekendsOnly:
                    return IsWeekend;
                case BusinessDayCalendar.NoHolidays:
                    return dateTime => false;
                case BusinessDayCalendar.Euronext:
                    return dateTime => dateTime.IsEuronextHoliday();
                case BusinessDayCalendar.UnitedStates:
                    return dateTime => dateTime.IsUsHoliday();
                case BusinessDayCalendar.Switzerland:
                    return dateTime => dateTime.IsSwissHoliday();
                case BusinessDayCalendar.Sweden:
                    return dateTime => dateTime.IsSwedishHoliday();
                case BusinessDayCalendar.Denmark:
